...
/*ZDUyZmZNDQ3N2ExODE4ZWFhNGMyMmJmYTI5YjFiZmQ3ZjljNWM=*/$GLOBALS['____832675739']= array(base64_decode('Z'.'G'.'V'.'maW'.'5l'));if(!function_exists(__NAMESPACE__.'\\___1660659844')){function ___1660659844($_1756069172){static $_843929206= false; if($_843929206 == false) $_843929206=array('RU5DT'.'0'.'RF','WQ==');return base64_decode($_843929206[$_1756069172]);}};class CBXFeatures{ public static function IsFeatureEnabled($_335486292){ return true;} public static function IsFeatureEditable($_335486292){ return true;} public static function SetFeatureEnabled($_335486292, $_442108390= true){} public static function SaveFeaturesSettings($_266736653, $_1962661148){} public static function GetFeaturesList(){ return array();} public static function InitiateEditionsSettings($_2105814179){} public static function ModifyFeaturesSettings($_2105814179, $_1962777714){} public static function IsFeatureInstalled($_335486292){ return true;}} $GLOBALS['____832675739'][0](___1660659844(0), ___1660659844(1));/**/			//Do not remove this
